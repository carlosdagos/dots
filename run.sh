...
function setup_dotfiles {
  ...
  soft_link "dotfiles/doom.d"            "$HOME/.doom.d"
  ...
  soft_link "dotfiles/dunstrc"           "$HOME/.config/dunst/dunstrc"
  ...
  soft_link "dotfiles/i3/py3status.conf" "$HOME/.config/i3/py3status.conf"
  soft_link "dotfiles/rofi"              "$HOME/.config/rofi"
  soft_link "nixpkgs"                    "$HOME/.config/nixpkgs"
